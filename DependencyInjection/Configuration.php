...
class Configuration implements ConfigurationInterface
{
    ...
    protected function handleRoot($rootNode): void
    {
        $rootNode
            ...
            ->integerNode('timeout')->info('For all local/remote processes, set their timeout in seconds. This timeout indicates after which duration without any data from the process we should consider it dead and we should restart it.')->min(5)->defaultValue(300)->end()
            ...
            ->integerNode('timeout')->info('Overide the *timeout* value.')->min(5)->defaultValue(300)->end()
